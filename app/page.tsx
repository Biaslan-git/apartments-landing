            ...
            <div className="space-y-8">
              {[
                ...
                },
                {
                  ...
                  desc: "Курение в помещениях апартаментов запрещено. Для курящих гостей предусмотрена обозначенная зона на улице. За нарушение этого правила предусмотрен дополнительный штраф."
                },
                {
