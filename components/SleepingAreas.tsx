      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-16">
          <div className="bg-white p-6 rounded-2xl shadow-md border border-[#E0E0E0] text-center">
            ...
            <h3 className="text-xl font-bold text-[#1A1A1A] mb-4">Спальня 1</h3>
            ...
            <h4 className="font-bold text-lg text-[#1A1A1A] mb-2">Двуспальная кровать</h4>
            <p className="text-[#1A1A1A]/70">Для комфортного отдыха двух гостей</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-2xl shadow-md border border-[#E0E0E0] text-center">
            ...
            <h3 className="text-xl font-bold text-[#1A1A1A] mb-4">Спальня 2</h3>
            <div className="relative h-48 rounded-xl overflow-hidden mb-4">
              <Image 
                src="/temp.jpg" 
            ...
            <h4 className="font-bold text-lg text-[#1A1A1A] mb-2">Двухъярусная кровать</h4>
            <p className="text-[#1A1A1A]/70">Для размещения еще двух гостей</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-2xl shadow-md border border-[#E0E0E0] text-center">
            ...
            <h3 className="text-xl font-bold text-[#1A1A1A] mb-4">Гостиная</h3>
            <div className="relative h-48 rounded-xl overflow-hidden mb-4">
              <Image 
                src="/temp.jpg" 
            ...
            <h4 className="font-bold text-lg text-[#1A1A1A] mb-2">Раскладной диван</h4>
            <p className="text-[#1A1A1A]/70">Для дополнительных двух гостей</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-8 shadow-lg border border-[#E0E0E0]">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <h3 className="text-2xl font-bold text-[#1A1A1A] mb-4">VIP-услуги и комфорт</h3>
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span className="text-[#1A1A1A]">Бесплатное постельное бельё и наборы полотенец</span>
                </li>
                <li className="flex items-start">
                  <div className="w-5 h-5 rounded-full bg-[#3A7D44] flex items-center justify-center mr-3 flex-shrink-0 mt-1">
                    <svg className="w-2 h-2 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span className="text-[#1A1A1A]">Халаты и тапочки при VIP-заселении</span>
                </li>
                <li className="flex items-start">
                  <div className="w-5 h-5 rounded-full bg-[#3A7D44] flex items-center justify-center mr-3 flex-shrink-0 mt-1">
                    <svg className="w-2 h-2 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span className="text-[#1A1A1A]">Свежее, чистое постельное бельё ко всем приездам</span>
                </li>
              </ul>
            </div>
