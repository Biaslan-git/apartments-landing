          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 border border-[#E0E0E0]">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 mb-8">
              <a 
                ...
                className="bg-[#3A7D44] hover:bg-[#2E6A3A] text-white font-bold py-4 px-8 rounded-xl transition duration-300 flex items-center justify-center gap-2 w-full"
              >
              ...
              <a 
                ...
                className="bg-[#25D366] hover:bg-[#128C7E] text-white font-bold py-4 px-8 rounded-xl transition duration-300 flex items-center justify-center gap-2 w-full"
              >
            ...
            <div className="mb-8">
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="bg-[#0088cc] hover:bg-[#0077b3] text-white font-bold py-4 px-8 rounded-xl transition duration-300 flex items-center justify-center gap-2 w-full"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
