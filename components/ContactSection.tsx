        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 border border-[#E0E0E0]">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a 
              ...
              className="bg-[#3A7D44] hover:bg-[#2E6A3A] text-white font-bold py-4 px-8 rounded-xl transition duration-300 flex items-center justify-center gap-2"
            >
            ...
            <a 
              ...
              className="bg-[#25D366] hover:bg-[#128C7E] text-white font-bold py-4 px-8 rounded-xl transition duration-300 flex items-center justify-center gap-2"
            >
