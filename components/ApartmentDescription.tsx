    ...
    <section className="py-16 px-4" id="description">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white p-6 rounded-2xl shadow-md border border-[#B8C1A9]">
            <div className="w-12 h-12 bg-[#ACB78D]/20 rounded-lg flex items-center justify-center mb-4">
        ...
        <div className="relative bg-gradient-to-r from-white to-[#C7D2AE] rounded-3xl overflow-hidden shadow-xl border border-[#B8C1A9]">
          <div className="grid lg:grid-cols-2">
            <div className="p-10 flex flex-col justify-center">
              <div className="mb-6">
                <span className="text-[#ACB78D] text-sm font-semibold uppercase tracking-wider">Домбай Апартаменты</span>
