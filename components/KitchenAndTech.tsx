    ...
    <section className="py-16 px-4" id="kitchen">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
          <div className="bg-white p-8 rounded-2xl shadow-lg border border-[#B8C1A9]">
            <div className="w-12 h-12 bg-[#ACB78D]/20 rounded-lg flex items-center justify-center mb-6">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-lg border border-[#B8C1A9]">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center p-6 bg-white rounded-xl border border-[#B8C1A9]">
              <div className="w-14 h-14 bg-[#ACB78D]/20 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#ACB78D]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
